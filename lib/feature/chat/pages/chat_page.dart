...
import 'package:whatsappclone/feature/chat/controller/chat_controller.dart';
import 'package:whatsappclone/feature/chat/widgets/chat_text_field.dart';
import 'package:whatsappclone/feature/chat/widgets/message_card.dart';
import 'package:whatsappclone/feature/chat/widgets/show_date_card.dart';
import 'package:whatsappclone/feature/chat/widgets/yellow_card.dart';
              ...
              children: [
                ...
                StreamBuilder(
                  ...
                  builder: (_, snapshot) {
                    ...
                    return Text(
                      singleUserModel.active ? 'online' : "ออนไลน์ล่าสุดเมื่อ $lastMessage ที่เเล้ว",
                      style: const TextStyle(
                        fontFamily: 'thai',
                        fontSize: 12,
                        color: Colors.white,
